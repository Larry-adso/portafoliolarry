            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped custom-table">
                    ...
                    <tbody class="tbody">
                        ...
                        // Consulta SQL para obtener los datos de pensiones del id_empresa del usuario
                        $sql = "SELECT * FROM pension WHERE id_empresa = ?";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            // Mostrar mensaje si no hay datos de pensiones registrados para ese id_empresa
                            echo "<tr><td colspan='3'>No hay datos de pensiones registrados para su empresa.</td></tr>";
                        }
